...
class ProdutoService {
    ...
    const NOME_CONFIGURACOES_PROD = 'change_tracking_produto';
    const NOME_CONFIGURACOES_COMPL_PROD = 'change_tracking_produto_complemento';
    const NOME_CONFIGURACOES_PESQUISA = 'change_tracking_produto_pesquisa';
