    ...
    public static function getDadosPagamentosPlataforma($timeStamp) {
        ...
        $dados = DB::connection('mysql_plataforma')->select(
                "SELECT
                    ...
                    p.created_at as 'pd_created_at',
                    p.updated_at as 'pd_updated_at'
                FROM pedidos p
    ...
    public static function flushPagamentos($dados) {
        ...
        Pagamentos::upsert($dados, ['pd_orçamento_id', 'pglj_orcamento_id'],
                [
                    ...
                    'pglj_cartao',
                    'pglj_link_cielo',
                    'pglj_image_qrcode_pix',
                    'pglj_emv',
                    'pglj_txid',
                    'pglj_end_to_end_id',
                    'pglj_link_boleto',
                    'pglj_boleto_tentativa',
                    'pglj_data_boleto',
                    'pglj_data_pagamento_boleto',
                    'pglj_data_pagamento_pix',
                    'pglj_nsu',
                    'pglj_tid',
                    'pglj_item_nsu_mu',
                    'pglj_status',
                    ...
                    'pgfnc_created_at',
                    'tpdoc_id',
                    'tpdoc_oid_forma_pagamento',
                    'tpdoc_oid_tipo_documento',
                    'tpdoc_nome',
                    'tpdoc_entrada',
                    'tpdoc_created_at',
                    'pd_created_at',
