...
return new class extends Migration {
    ...
    public function up() {
        Schema::create('base_cal_fats', function (Blueprint $table) {
            ...
            $table->double('base_cont',9)->nullable(true);
            $table->double('bas_en_cont',9)->nullable(true);
            $table->string('cod_mensagem', 2);
            $table->double('aliq_cont',5)->nullable(true);
            $table->double('aliq_n_cont',5)->nullable(true);
            $table->double('perc_subtri',9)->nullable(true);
            ...
            $table->double('alq_cred_icms_st',5)->nullable(true);
            $table->double('alq_deb_icms_st',5)->nullable(true);
            ...
            $table->double('base_cred_icms_st',5)->nullable(true);
            $table->double('base_deb_icms_st',5)->nullable(true);
