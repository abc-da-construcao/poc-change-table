...
return new class extends Migration {
    ...
    public function up() {
        Schema::create('base_cal_fats', function (Blueprint $table) {
                        ...
                        $table->decimal('bas_en_cont',9)->nullable(true);
                        $table->string('cod_mensagem', 2);
                        $table->decimal('aliq_cont',5)->nullable(true);
                        $table->decimal('aliq_n_cont',5)->nullable(true);
                        $table->decimal('perc_subtri',9)->nullable(true);
                        ...
                        $table->decimal('alq_cred_icms_st',5)->nullable(true);
                        $table->decimal('alq_deb_icms_st',5)->nullable(true);
                        ...
                        $table->decimal('base_cred_icms_st',5)->nullable(true);
                        $table->decimal('base_deb_icms_st',5)->nullable(true);
